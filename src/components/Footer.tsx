...
export const Footer: React.FC<FooterProps> = ({ onNavigate }) => {
  return (
    <footer className="bg-brand-navy text-white w-full py-8 px-4 md:px-12 grid grid-cols-1 md:grid-cols-4 gap-8 border-t-4 border-accent-saffron mt-auto">
      <div className="col-span-1 md:col-span-1 flex flex-col gap-2">
        ...
        <p className="text-[11px] text-brand-navy-light-text mt-2">
      ...
      <div className="col-span-1 md:col-span-2 flex flex-wrap gap-x-6 gap-y-3 items-center text-xs font-semibold">
        <button
          ...
          className="text-white hover:text-accent-saffron-text underline transition-all opacity-90 hover:opacity-100 text-left cursor-pointer"
        >
          About SANKET
        </button>
