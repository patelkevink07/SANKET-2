    ...
    <div className="flex-grow w-full py-8 bg-canvas">
      <div className="max-w-[1000px] mx-auto px-4 md:px-8">
        ...
        <div className="mb-4 flex items-center text-xs text-text-muted">
          ...
          <span className="text-text-primary font-semibold">Contact &amp; Help Desk</span>
        </div>
        ...
        <div className="bg-surface border border-border-main p-6 md:p-8 shadow-sm space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs text-text-secondary">
            <div className="p-4 bg-canvas border border-border-main rounded space-y-2">
              <h3 className="font-serif-headline text-base font-bold text-text-navy">
