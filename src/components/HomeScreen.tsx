...
export const HomeScreen: React.FC<HomeScreenProps> = ({
  ...
  return (
    <div className="flex-grow flex flex-col w-full">
      {/* Breadcrumb */}
      <div className="bg-white py-2 px-3 sm:px-6 lg:px-8 border-b border-[#CCCCCC]">
        <div className="max-w-[1280px] mx-auto text-xs text-[#737780] flex items-center gap-1.5">
          <button
            onClick={() => onNavigate('home')}
            className="hover:underline text-[#001e40] font-medium"
          >
            Portal
          </button>
          <span>&gt;</span>
          <span className="text-[#1a1c1c] font-semibold">Home</span>
        </div>
      </div>

      {/* Hero Band */}
      <section className="bg-[#eeeeee] py-8 md:py-12 px-3 sm:px-6 lg:px-8 border-b border-[#CCCCCC]">
        <div className="max-w-[1280px] mx-auto flex flex-col lg:flex-row gap-8 items-center">
          <div className="w-full lg:w-3/5">
            <div className="inline-flex items-center gap-2 px-2.5 py-1 bg-white border border-[#c3c6d1] rounded text-[11px] font-bold text-[#003366] uppercase mb-2">
              <span className="w-2 h-2 rounded-full bg-[#fe6500] animate-ping"></span>
              <span>Smart India Hackathon 2026 &bull; Problem Statement #26152</span>
            </div>
            <h1 className="font-serif-headline text-3xl sm:text-4xl lg:text-[42px] font-bold text-[#0C0566] mb-1 tracking-tight leading-tight">
              SANKET
            </h1>
            <h2 className="font-serif-headline text-lg sm:text-xl font-bold text-[#fe6500] mb-4 uppercase tracking-wider">
            ...
            <div className="mt-6 flex flex-wrap items-center gap-3">
              <button
                ...
                className="py-2.5 px-5 sm:px-6 bg-[#003366] hover:bg-[#0C0566] text-white font-bold text-xs uppercase tracking-wider transition-all duration-300 flex items-center gap-2 border border-[#001e40] shadow-sm active:scale-95"
              >
                <span>Launch Analytics Console</span>
                <span className="material-symbols-outlined text-[16px]">arrow_forward</span>
              </button>

              {/* Interactive Color-Shifting Placeholder Button */}
              ...
              <button
                ...
                className="py-2.5 px-4 sm:px-5 bg-white hover:bg-[#f3f3f3] text-[#001e40] font-bold text-xs uppercase tracking-wider transition-colors border border-[#CCCCCC] flex items-center gap-2"
              >
          ...
          <div className="w-full lg:w-2/5 flex justify-center">
            <div
              ...
              className="relative group cursor-pointer overflow-hidden rounded border border-[#CCCCCC] bg-white p-2 shadow-sm hover:shadow-xl transition-all duration-300 transform hover:scale-[1.03]"
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-[#003366]/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded flex flex-col items-center justify-center p-4">
                <span className="bg-[#001e40] text-white text-xs font-bold px-3 py-1.5 rounded shadow flex items-center gap-1.5">
      ...
      <section className="py-8 md:py-10 px-3 sm:px-6 lg:px-8 bg-white border-b border-[#CCCCCC]">
        <div className="max-w-[1280px] mx-auto">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-2 mb-6">
            <div>
              <h3 className="font-serif-headline text-2xl font-bold text-[#0C0566] border-b-2 border-[#001e40] pb-1 inline-block">
                Core Capabilities
              </h3>
            ...
            <button
              onClick={() => onNavigate('dashboards')}
              className="text-xs font-bold text-[#003366] hover:text-[#fe6500] transition-colors flex items-center gap-1"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div
              ...
              className="bg-white border border-[#CCCCCC] p-4 rounded hover:border-[#003366] hover:shadow-md transition-all duration-200 cursor-pointer flex flex-col group"
            >
              <div className="flex items-center gap-2 mb-2 bg-[#f3f3f3] p-2.5 border-b border-[#CCCCCC] group-hover:bg-[#d5e3ff]/40 transition-colors">
                <span className="material-symbols-outlined text-[#003366]">database</span>
                <h4 className="font-serif-headline text-lg font-bold text-[#0C0566]">Data Collection</h4>
              </div>
              <p className="text-sm text-[#43474f] leading-relaxed pt-1">
              ...
              <div className="mt-auto pt-3 border-t border-[#f3f3f3] flex items-center justify-between text-xs text-[#003366] font-semibold">
            ...
            >
              <div className="flex items-center gap-2 mb-2 bg-[#f3f3f3] p-2.5 border-b border-[#CCCCCC] group-hover:bg-[#d5e3ff]/40 transition-colors">
                ...
                <h4 className="font-serif-headline text-lg font-bold text-[#0C0566]">Sentiment Analysis</h4>
              </div>
              <p className="text-sm text-[#43474f] leading-relaxed pt-1">
            ...
            >
              <div className="flex items-center gap-2 mb-2 bg-[#f3f3f3] p-2.5 border-b border-[#CCCCCC] group-hover:bg-[#d5e3ff]/40 transition-colors">
                ...
                <h4 className="font-serif-headline text-lg font-bold text-[#0C0566]">Demographics</h4>
              </div>
              <p className="text-sm text-[#43474f] leading-relaxed pt-1">
            ...
            <div
              ...
              className="bg-white border border-[#CCCCCC] p-4 rounded hover:border-[#003366] hover:shadow-md transition-all duration-200 cursor-pointer flex flex-col group lg:col-span-1"
            >
              <div className="flex items-center gap-2 mb-2 bg-[#f3f3f3] p-2.5 border-b border-[#CCCCCC] group-hover:bg-[#d5e3ff]/40 transition-colors">
                <span className="material-symbols-outlined text-[#003366]">monitoring</span>
                <h4 className="font-serif-headline text-lg font-bold text-[#0C0566]">Trend Identification</h4>
              </div>
              <p className="text-sm text-[#43474f] leading-relaxed pt-1">
            ...
            <div
              ...
              className="bg-white border border-[#CCCCCC] p-4 rounded hover:border-[#003366] hover:shadow-md transition-all duration-200 cursor-pointer flex flex-col group lg:col-span-2"
            >
              <div className="flex items-center gap-2 mb-2 bg-[#f3f3f3] p-2.5 border-b border-[#CCCCCC] group-hover:bg-[#d5e3ff]/40 transition-colors">
                <span className="material-symbols-outlined text-[#003366]">hub</span>
                <h4 className="font-serif-headline text-lg font-bold text-[#0C0566]">Network Graphing</h4>
              </div>
              <p className="text-sm text-[#43474f] leading-relaxed pt-1">
      ...
      <section className="max-w-[1280px] mx-auto w-full grid grid-cols-1 lg:grid-cols-3 gap-6 py-8 px-3 sm:px-6 lg:px-8">
        ...
        <div className="lg:col-span-2 bg-[#eeeeee] border border-[#CCCCCC] p-6 rounded flex flex-col justify-center shadow-xs">
          <div className="flex flex-col sm:flex-row items-center gap-6 justify-around">
            ...
            >
              ...
              />
              <p className="font-bold text-sm text-[#0C0566]">
              ...
              <button
                ...
                className="text-xs text-[#003366] hover:underline font-semibold mt-1"
              >
        ...
        <div className="bg-white border border-[#CCCCCC] rounded flex flex-col shadow-xs">
          <div className="bg-[#f3f3f3] p-3 border-b border-[#CCCCCC] flex items-center justify-between">
            <h4 className="font-serif-headline text-base font-bold text-[#0C0566]">
              Notices &amp; Updates
            </h4>
            <button
          ...
          <ul className="p-3 flex flex-col gap-2.5">
            {MOCK_NOTICES.map((notice) => (
              <li
                key={notice.id}
                className="border-b border-[#e2e2e2] pb-2.5 last:border-0 last:pb-0"
              >
                <div className="flex items-start gap-2">
                  {notice.isNew && (
                    <span className="bg-[#E31E2E] text-white font-bold px-1.5 py-0.5 rounded-sm text-[9px] mt-0.5 tracking-wider">
                      NEW
                    </span>
                  )}
                  <div>
                    <p
                      onClick={() => onNavigate('knowledge')}
                      className="text-xs font-medium text-[#1a1c1c] hover:text-[#003366] cursor-pointer underline decoration-[#c3c6d1] leading-snug"
                    >
                      {notice.title}
                    </p>
                    <p className="text-[11px] text-[#737780] mt-0.5 font-mono">
                      {notice.date}
                    </p>
                  </div>
                </div>
