  ...
  return (
    <div className="flex-grow flex flex-col w-full bg-page transition-colors duration-200">
      ...
      <section className="bg-banner py-8 md:py-12 px-3 sm:px-6 lg:px-8 border-b border-main">
        <div className="max-w-[1280px] mx-auto flex flex-col lg:flex-row gap-8 items-center">
          <div className="w-full lg:w-3/5">
            ...
            <p className="text-sm sm:text-base text-secondary text-justify leading-relaxed">
            ...
            <div className="mt-6 flex flex-wrap items-center gap-3">
              ...
              <button
                ...
                className="py-2.5 px-4 sm:px-5 bg-surface hover:bg-subtle text-navy font-bold text-xs uppercase tracking-wider transition-colors border border-main flex items-center gap-2 cursor-pointer"
              >
          ...
          <div className="w-full lg:w-2/5 flex justify-center">
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-navy-main/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded flex flex-col items-center justify-center p-4">
                <span className="bg-navy-dark text-white text-xs font-bold px-3 py-1.5 rounded shadow flex items-center gap-1.5">
      ...
      <section className="max-w-[1280px] mx-auto w-full grid grid-cols-1 lg:grid-cols-3 gap-6 py-8 px-3 sm:px-6 lg:px-8">
        ...
        <div className="lg:col-span-2 bg-banner border border-main p-6 rounded flex flex-col justify-center shadow-xs">
          <div className="flex flex-col sm:flex-row items-center gap-6 justify-around">
            ...
            <div className="h-[1px] w-full sm:w-[1px] sm:h-24 bg-main"></div>
            ...
            >
              ...
              />
              <p className="font-bold text-sm text-headline">
              ...
              <button
                ...
                className="text-xs text-brand hover:underline font-semibold mt-1 cursor-pointer"
              >
        ...
        <div className="bg-surface border border-main rounded flex flex-col shadow-xs">
          <div className="bg-subtle p-3 border-b border-main flex items-center justify-between">
            <h4 className="font-serif-headline text-base font-bold text-headline">
              Notices &amp; Updates
            </h4>
            <button
          ...
          <ul className="p-3 flex flex-col gap-2.5">
            {MOCK_NOTICES.map((notice) => (
              <li
                key={notice.id}
                className="border-b border-subtle pb-2.5 last:border-0 last:pb-0"
              >
                <div className="flex items-start gap-2">
                  {notice.isNew && (
                    <span className="bg-danger-main text-white font-bold px-1.5 py-0.5 rounded-sm text-[9px] mt-0.5 tracking-wider">
                      NEW
                    </span>
                  )}
                  <div>
                    <p
                      onClick={() => onNavigate('knowledge')}
                      className="text-xs font-medium text-primary hover:text-brand cursor-pointer underline decoration-card leading-snug"
                    >
                      {notice.title}
                    </p>
